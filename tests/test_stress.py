...
# import redis
#
# from atm_service import ATMService, make_round
...
#
#     # Initial total
#     initial_total = atm_service.get_total()['total']
...
#
#     # Final total
#     final_total = atm_service.get_total()['total']
...
#     assert make_round(final_total) == make_round(expected_total), "The final total does not match the expected total from transactions"
#
#
